...
import { createCredential, getAllUserCredentials, getOneUserCredential } from "../controllers/credentialsController.js";
...
credentialsRoute.get("/credentials/:credentialId", validToken, getOneUserCredential);
